package exam.day03view.selectView.view.adapter3;
...
public class ExamAdapter extends ArrayAdapter<ActorItem> {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        if (convertView == null) {
            ...
            Log.d("firstjob", "최초작업==>" + data.get(position));
        }
        ...
        if (actorItem != null) {
            ...
            myimg.setImageResource(actorItem.exam_img);
            nameView.setText(actorItem.name);
            dateView.setText(actorItem.date);
            info.setText(actorItem.comment);
